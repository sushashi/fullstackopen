...
test('5.16 new blog form', async () => {
  ...
  const inputTitle = blogFormComponent.container.querySelector(
    "input[name='Title']",
  )
  const inputAuthor = blogFormComponent.container.querySelector(
    "input[name='Author']",
  )
  const inputUrl =
    blogFormComponent.container.querySelector("input[name='Url']")
  ...
  expect(createBlog.mock.calls[0][0].title).toBe(
    'Title of the blog for testing purpose',
  )
  expect(createBlog.mock.calls[0][0].author).toBe(
    'Author of the blog for testing purpose',
  )
