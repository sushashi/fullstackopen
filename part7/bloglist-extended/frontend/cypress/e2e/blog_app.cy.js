  ...
  describe('Login', function () {
    ...
    describe('When logged in', function () {
      ...
      it('A blog can be created', function () {
        ...
        cy.contains(
          'a new blog This is the title of a blog by Author von Blogger added',
        )
      ...
      describe('When it contains a blog', function () {
        ...
        it('A User who created a blog can delete it', function () {
          ...
          cy.contains('This is the title of a blog Author von Blogger').should(
            'not.exist',
          )
        })
      ...
      describe('When it contains more blogs', function () {
        ...
        it('Blogs are ordered according to likes', function () {
          cy.contains('This is the title of a second blog Author von Blogger')
            .contains('view')
            .click()
          cy.contains('This is the title of a second blog Author von Blogger')
            .contains('like')
          ...
          cy.contains('This is the title of a third blog Author von Blogger')
            .contains('view')
            .click()
          cy.contains('This is the title of a third blog Author von Blogger')
            .contains('like')
          ...
          cy.get('.blogShown')
            .eq(0)
            .should('contain', 'This is the title of a second blog')
          cy.get('.blogShown')
            .eq(1)
            .should('contain', 'This is the title of a third blog')
          cy.get('.blogShown')
            .eq(2)
            .should('contain', 'This is the title of a blog')
        })
      })
    })
  })
